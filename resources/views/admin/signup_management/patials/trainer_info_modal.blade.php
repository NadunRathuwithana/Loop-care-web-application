        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="d-flex justify-content-between">
                    ...
                    <div>
                        <button type="button" class="btn btn-outline-primary"><i class='bx bxs-download'></i> Traning
                            Licence</button>
                    </div>
                </div>
                <div class="row mt-2">
                ...
                <div class="row">
                    <p class="m-0">Working Gym/ Sport Unit : Fitness Gym</p>
                    <p class="m-0">District : Colombo</p>
                    <p class="m-0">Reg No : 23213213</p>
                </div>
