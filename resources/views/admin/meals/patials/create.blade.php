                    ...
                    <div class="row">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control"
                                placeholder="Sweet potato with fried chicken" />
                        </div>
                        ...
                        <div>
                            ...
                            <textarea class="form-control" placeholder="Enter instructions here" id="floatingTextarea2" style="height: 100px"></textarea>
                        </div>
