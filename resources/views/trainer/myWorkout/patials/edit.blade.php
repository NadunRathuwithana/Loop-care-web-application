{{--  create modal  --}}
<div class="modal fade" id="createModal" aria-hidden="true" aria-labelledby="exampleModalToggleLabel" tabindex="-1">
                            ...
                            <div class="d-flex gap-2 align-items-end mb-3">
                                ...
                                <div class="w-25">
                                    <button type="button" class="btn btn-main-sq btn-ui w-100"
                                        data-bs-target="#newPlaylist" data-bs-toggle="modal"
