...
@section('content')
    ...
    <div class="container px-md-5 hero-slider mt-3">
        <h1 class="modal-title fs-5" id="exampleModalLabel">Create Workout</h1>
            ...
            <div class="row">
                ...
                <div class="col-6">
                    <div class="d-flex gap-2 align-items-end mb-3">
                        ...
                        <div class="w-25">
                            <button type="button" class="btn btn-main-sq btn-ui w-100" data-bs-target="#newPlaylist"
                ...
                <div class="mb-3 col-12">
                    ...
                    <div>
                        ...
                        <div class="form-check form-check-inline ">
                            <input class="form-check-input" type="checkbox" value="" id="low-pressure">
                            <label class="form-check-label" for="low-pressure">
                                Low pressure
                            </label>
                        </div>
                        <div class="form-check form-check-inline ">
                            <input class="form-check-input" type="checkbox" value="" id="high-pressure">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-gray-sq btn-ui" data-bs-target="#createModal"
                    data-bs-toggle="modal" data-bs-dismiss="modal">Close</button>
                <button type="button" class="btn btn-main-sq btn-ui" data-bs-target="#createModal"
                    data-bs-toggle="modal" data-bs-dismiss="modal">Save</button>
            </div>
        </div>
    </div>
</div>
<a class="btn btn-primary" data-bs-toggle="modal" href="#createModal" role="button">Open first modal</a>
